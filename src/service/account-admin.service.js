...
const getAll = async (req) => {
    try {
        ...
        const [data, totalData] = await Promise.all([
            accountAdminRepo.findAll(options, filter),
            accountAdminRepo.count(filter)
        ]);
...
const getDetail = async (req) => {
    try {
        ...
        const data = await accountAdminRepo.findOne({ account_id: dataId });
...
const create = async (req) => {
    ...
    try {
        ...
        const createData = await accountAdminRepo.create(payload, transaction);
...
const update = async (req) => {
    ...
    try {
        ...
        await accountAdminRepo.update(payload, { account_id: dataId }, transaction);
